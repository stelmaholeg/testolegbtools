...
<form action="<?php echo JRoute::_('index.php?option=com_filial&a_id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate">
	<fieldset>
	...
	<fieldset>
		<legend><?php echo JText::_('COM_FILIAL_IMAGES_AND_URLS'); ?></legend>
			<div class="formelm">
	...
	<fieldset>
		<legend><?php echo JText::_('COM_FILIAL_PUBLISHING'); ?></legend>
		<div class="formelm">
	...
	<?php endif; ?>
		...
		<?php if (is_null($this->item->id)):?>
			<div class="form-note">
			<p><?php echo JText::_('COM_FILIAL_ORDERING'); ?></p>
			</div>
		<?php endif; ?>
	</fieldset>
	...
	<fieldset>
		<legend><?php echo JText::_('COM_FILIAL_METADATA'); ?></legend>
		<div class="formelm-area">
