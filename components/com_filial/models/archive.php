...
/**
 * Filial Component Archive Model
 *
 * @package		Joomla.Site
 * @subpackage	com_filial
 * @since		1.5
 */
class FilialModelArchive extends FilialModelArticles
{
	/**
	 ...
	 * @var		string
	 */
	public $_context = 'com_filial.archive';
	...
	protected function populateState($ordering = null, $direction = null)
	{
		...
		$limit = $app->getUserStateFromRequest('com_filial.archive.list' . $itemid . '.limit', 'limit', $params->get('display_num'), 'uint');
	...
	function getListQuery()
	{
		...
		$queryDate = FilialHelperQuery::getQueryDate($articleOrderDate);
	...
	public function getData()
	{
		...
		// Lets load the filial if it doesn't already exist
		if (empty($this->_data)) {
