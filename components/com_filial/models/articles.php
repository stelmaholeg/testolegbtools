 ...
 * @since		1.6
 */
class FilialModelArticles extends JModelList
{
	...
	function getListQuery()
	{
		...
		if ($this->context != 'com_filial.featured') {
			$query->join('LEFT', '#__filial_frontpage AS fp ON fp.filial_id = a.id');
		}
	...
	public function getItems()
	{
		...
		$globalParams = JComponentHelper::getParams('com_filial', true);
		...
		foreach ($items as &$item)
		{
			...
			if (!$guest) {
				$asset	= 'com_filial.article.'.$item->id;
