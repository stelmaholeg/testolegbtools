...
*
* @version $Id: shop_browse_queries.php 2435 2010-06-15 11:22:37Z tkahl $
* @package VirtueMart
* @subpackage html
...
$where_clause[] = '`#__{vm}_product`.`product_discount_id`  IN
	(SELECT discount_id FROM #__{vm}_product_discount WHERE (start_date<'.$time.' OR start_date=0) AND( end_date >='.$time.' OR end_date=NULL OR end_date=0 ))';
