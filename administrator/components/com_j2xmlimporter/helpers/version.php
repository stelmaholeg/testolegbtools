<?php
/**
 * @version		1.6.0.72 helpers/version.php
...
class j2xmlVersion
{
	...
	public static $BUILD		= '72';
	/** @public static string Codename */
	public static $CODENAME	= 'Treglia';
	/** @public static string Copyright Text */
	public static $COPYRIGHT	= 'Copyright &copy; 2010-2012 Helios Ciancio <a href="http://www.eshiol.it" title="eshiol.it"><img src="components/com_j2xmlimporter/assets/images/eshiol.png" alt="eshiol.it" /></a>. All rights reserved.';
	/** @public static string License */
	public static $LICENSE	= '<a href="http://www.gnu.org/licenses/gpl-3.0.html">GNU GPL v3</a>';	
	/** @public static string URL */
	public static $URL		= '<a href="http://www.eshiol.it/joomla/j2xml/j2xml-importer-1600.html">J2XMLImporter</a> is Free Software released under the GNU General Public License.';
