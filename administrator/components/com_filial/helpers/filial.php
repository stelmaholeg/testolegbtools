...
class FilialHelper
{
	public static $extension = 'com_filial';
	...
	public static function addSubmenu($vName)
	{
		JSubMenuHelper::addEntry(
			...
			'index.php?option=com_filial&view=articles',
			$vName == 'articles'
		);
		JSubMenuHelper::addEntry(
			JText::_('COM_FILIAL_SUBMENU_CATEGORIES'),
			'index.php?option=com_categories&extension=com_filial',
			$vName == 'categories');
		/*JSubMenuHelper::addEntry(
			JText::_('COM_FILIAL_SUBMENU_FEATURED'),
			'index.php?option=com_filial&view=featured',
			$vName == 'featured'
		);*/
                JSubMenuHelper::addEntry(
	...
	public static function getActions($categoryId = 0, $articleId = 0)
	{
		...
		if (empty($articleId) && empty($categoryId)) {
			$assetName = 'com_filial';
		}
		elseif (empty($articleId)) {
			$assetName = 'com_filial.category.'.(int) $categoryId;
		}
		else {
			$assetName = 'com_filial.article.'.(int) $articleId;
		}
	...
	/**
	* Applies the filial tag filters to arbitrary text as per settings for current user group
