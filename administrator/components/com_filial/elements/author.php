...
class JElementAuthor extends JElement
{
	...
	function fetchElement($name, $value, &$node, $control_name)
	{
		...
		// Include user in groups that have access to edit their articles, other articles, or manage filial.
		$action = array('com_filial.article.edit_own', 'com_filial.article.edit_article', 'com_filial.manage');
