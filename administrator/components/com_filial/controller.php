 ...
 */
class FilialController extends JControllerLegacy
{
	/**
	...
	{
		// Load the submenu.
		FilialHelper::addSubmenu(JRequest::getCmd('view', 'articles'));
		...
		// Check for edit form.
		if ($view == 'article' && $layout == 'edit' && !$this->checkEditId('com_filial.edit.article', $id)) {
			// Somehow the person just went to the form - we don't allow that.
			$this->setError(JText::sprintf('JLIB_APPLICATION_ERROR_UNHELD_ID', $id));
			$this->setMessage($this->getError(), 'error');
			$this->setRedirect(JRoute::_('index.php?option=com_filial&view=articles', false));
