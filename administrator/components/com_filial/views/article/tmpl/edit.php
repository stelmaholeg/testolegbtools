...
<form action="<?php echo JRoute::_('index.php?option=com_filial&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="item-form" class="form-validate">
	<div class="width-60 fltlft">
		<fieldset class="adminform">
			<legend><?php echo empty($this->item->id) ? JText::_('COM_FILIAL_NEW_ARTICLE') : JText::sprintf('COM_FILIAL_EDIT_ARTICLE', $this->item->id); ?></legend>
	...
	<div class="width-40 fltrt">
		<?php echo JHtml::_('sliders.start', 'filial-sliders-'.$this->item->id, array('useCookie'=>1)); ?>
		<?php // Do not show the publishing options if the edit form is configured not to. ?>
		<?php  if ($params['show_publishing_options'] || ( $params['show_publishing_options'] = '' && !empty($editoroptions)) ): ?>
			<?php echo JHtml::_('sliders.panel', JText::_('COM_FILIAL_FIELDSET_PUBLISHING'), 'publishing-details'); ?>
		...
		<?php  $fieldSets = $this->form->getFieldsets('attribs'); ?>
			...
			<fieldset class="panelform">
				...
				<?php if ( $this->canDo->get('core.admin')   ):  ?>
					<?php  echo JHtml::_('sliders.panel', JText::_('COM_FILIAL_SLIDER_EDITOR_CONFIG'), 'configure-sliders'); ?>
						<fieldset  class="panelform" >
							<ul class="adminformlist">
		...
		<?php if ($params['show_urls_images_backend']): ?>
			<?php echo JHtml::_('sliders.panel', JText::_('COM_FILIAL_FIELDSET_URLS_AND_IMAGES'), 'urls_and_images-options'); ?>
				<fieldset class="panelform">
				<ul class="adminformlist">
					<li>
	...
	<?php if ($this->canDo->get('core.admin')): ?>
		<div class="width-100 fltlft">
			<?php echo JHtml::_('sliders.start', 'permissions-sliders-'.$this->item->id, array('useCookie'=>1)); ?>
				...
				<?php echo JHtml::_('sliders.panel', JText::_('COM_FILIAL_FIELDSET_RULES'), 'access-rules'); ?>
				<fieldset class="panelform">
