...
$canOrder	= $user->authorise('core.edit.state', 'com_filial.article');
$saveOrder	= $listOrder == 'fp.ordering';
?>
<form action="<?php echo JRoute::_('index.php?option=com_filial&view=featured');?>" method="post" name="adminForm" id="adminForm">
	...
	<table class="adminlist">
		...
		foreach ($this->items as $i => $item) :
			...
			$assetId	= 'com_filial.article.'.$item->id;
			...
			<tr class="row<?php echo $i % 2; ?>">
				...
				<td>
					...
					<?php endif; ?>
					<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_filial&task=article.edit&return=featured&id='.$item->id);?>">
